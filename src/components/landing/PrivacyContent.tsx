    ...
    <main className="min-h-[100dvh] bg-[#FAF8F5] dark:bg-[#1A1816] text-[#2D2926] dark:text-[#FAF8F5] selection:bg-[#B34B44]/20 selection:text-[#B34B44] font-sans pb-32">
      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-12">
        ...
        <div className="space-y-24 md:space-y-32">
          <PrivacySection label={t("sections.controller.label")} title={t("sections.controller.title")}>
          ...
          <PrivacySection label={t("sections.data.label")} title={t("sections.data.title")}>
            <p className="text-lg md:text-xl text-[#5C5652] dark:text-[#A8A29E] leading-relaxed font-light">
              {t("sections.data.content")}
            </p>
          </PrivacySection>

          <PrivacySection label={t("sections.rights.label")} title={t("sections.rights.title")}>
            <p className="text-lg md:text-xl text-[#5C5652] dark:text-[#A8A29E] leading-relaxed font-light">
              {t("sections.rights.content")}
            </p>
          </PrivacySection>

          <PrivacySection label={t("sections.cookies.label")} title={t("sections.cookies.title")}>
            <p className="text-lg md:text-xl text-[#5C5652] dark:text-[#A8A29E] leading-relaxed font-light">
