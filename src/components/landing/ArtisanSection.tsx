          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <m.div variants={textFadeUp} className="pt-8 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4">
                 {/* EC Card */}
                 <div className="bg-white/50 dark:bg-white/[0.03] border border-stone-200/50 dark:border-white/[0.05] rounded-2xl h-16 min-w-[140px] px-6 flex items-center justify-center hover:bg-white dark:hover:bg-white/[0.06] hover:border-[#B34B44]/20 transition-all duration-300 group shadow-sm text-[#2D2926] dark:text-[#FAF8F5]">
