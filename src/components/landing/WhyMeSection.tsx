          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10">
            ...
            >
              <div className="flex flex-col h-full relative z-10 gap-6">
                <span className="text-sm uppercase tracking-[0.2em] text-stone-400 dark:text-stone-500 font-bold">{t("bento.professionalism.label")}</span>
                ...
                <p className="text-base text-[#5C5652] dark:text-[#A8A29E] leading-relaxed font-light max-w-lg">
                  {t("bento.professionalism.description")}
                </p>
              </div>
            ...
            >
              <div className="flex flex-col h-full relative z-10 gap-6">
                <span className="text-sm uppercase tracking-[0.2em] text-stone-400 dark:text-stone-500 font-bold">{t("bento.trust.label")}</span>
                ...
                <p className="text-base text-[#5C5652] dark:text-[#A8A29E] leading-relaxed font-light">
                  {t("bento.trust.description")}
                </p>
              </div>
              <div className="absolute -right-10 -bottom-10 opacity-[0.03] dark:opacity-[0.06] group-hover:opacity-[0.06] transition-opacity duration-700 pointer-events-none">
            ...
            >
              <div className="flex flex-col h-full relative z-10 gap-6">
                <span className="text-sm uppercase tracking-[0.2em] text-stone-400 dark:text-stone-500 font-bold">{t("bento.performance.label")}</span>
                <h3 className="text-3xl md:text-4xl font-bold text-[#2D2926] dark:text-[#FAF8F5] tracking-tighter leading-tight">
            ...
            >
              <div className="flex flex-col h-full relative z-10 gap-6">
                <span className="text-sm uppercase tracking-[0.2em] text-stone-400 dark:text-stone-500 font-bold">{t("bento.design.label")}</span>
                <h3 className="text-3xl md:text-4xl font-bold text-[#2D2926] dark:text-[#FAF8F5] tracking-tighter leading-tight max-w-xl">
